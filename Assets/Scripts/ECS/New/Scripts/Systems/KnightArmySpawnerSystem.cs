...
partial struct KnightArmySpawnerSystem : ISystem {
    ...
    public void OnUpdate(ref SystemState state) {
        ...
        foreach ((
           ...
           RefRW<KnightArmy> horde,
           Entity entity)
           in SystemAPI.Query<
               RefRO<LocalTransform>,
               RefRW<KnightArmy>>().WithEntityAccess()) {
            ...
            if (horde.ValueRO.knightAmountToSpawn <= 0) {
            ...
            if (horde.ValueRO.spawnTimer <= 0) {
                ...
                Entity zombieEntity = entityCommandBuffer.Instantiate(entitiesReferences.knightPrefabEntity);
                ...
                horde.ValueRW.knightAmountToSpawn--;
            }
        }
    }
}