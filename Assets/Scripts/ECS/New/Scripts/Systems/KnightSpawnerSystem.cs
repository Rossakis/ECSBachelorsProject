...
partial struct KnightSpawnerSystem : ISystem {
    ...
    public void OnUpdate(ref SystemState state) {
        ...
        foreach ((
            ...
            RefRW<KnightSpawner> zombieSpawner)
            in SystemAPI.Query<
            ...
            if (collisionWorld.OverlapSphere(
                ...
                zombieSpawner.ValueRO.nearbyKnightAmountDistance,
                ref distanceHitList,
                collisionFilter)) {
            ...
            if (nearbyZombieAmount >= zombieSpawner.ValueRO.nearbyKnightAmountMax) {
                continue;
            }

            Entity zombieEntity = state.EntityManager.Instantiate(entitiesReferences.knightPrefabEntity);
