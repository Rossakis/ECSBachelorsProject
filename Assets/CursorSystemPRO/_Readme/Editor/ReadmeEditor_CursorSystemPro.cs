...
namespace CursorSystemPRO._Readme.Editor {

    [CustomEditor(typeof(Readme_CursorSystemPro))]
    [InitializeOnLoad]
    public class ReadmeEditor_CursorSystemPro : UnityEditor.Editor {

        static float kSpace = 16f;

        protected override void OnHeaderGUI() {
            var readme = (Readme_CursorSystemPro)target;
            Init();
